...
## TODO
- [ ] The RLCD screen is not colourful, so it's not fully compatible with Vertex-Agent's animations. A good solution for converting colourful graphics to black-and-white should be found.  
