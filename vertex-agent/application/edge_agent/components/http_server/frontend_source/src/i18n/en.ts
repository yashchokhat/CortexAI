export const en = {
  docTitle: 'Vertex-Agent Settings',
  ...
  webimDesc: 'Interact with Vertex-Agent in real time via WebSocket.',
  webimSend: 'Send',
  webimOnline: 'Online',
  ...
  webreqSearchNote: 'Optional. If set, Vertex-Agent can search online.',
