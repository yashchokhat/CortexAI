...
const LS_CHAT_ID = 'vertex-agent-webim-chat-id';
const MARKED_CDN_URL = 'https://vertex-agent.com/clientjs/marked@18.0.4/marked.umd.min.js';
const DOMPURIFY_CDN_URL = 'https://vertex-agent.com/clientjs/dompurify@3.4.5/purify.min.js';
