...
function(lua_module_builder_configure_builtin_lua_sync)
    ...
    add_custom_target(lua_module_builder_sync_builtin_scripts ALL
        COMMAND ${python}
    ...
    add_custom_target(lua_module_builder_generate_builtin_lua_modules_skill ALL
        COMMAND ${python}
    ...
    add_custom_target(lua_module_builder_sync_docs ALL
        COMMAND ${python}
                "${tools_dir}/sync_lua_module_docs.py"
                ${common_script_args}
