...
{
  "name": "ble",
  "description": "Operate Vertex-Agent BLE: initialize BLE, advertise, handle connections, process events, and inspect module state.",
  "metadata": {
    "cap_groups": [
      "cap_lua"
    ],
...
This skill describes how an Agent can control the BLE module on Vertex-Agent via
