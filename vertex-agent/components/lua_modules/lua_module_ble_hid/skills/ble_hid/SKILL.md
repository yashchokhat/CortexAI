...
{
  "name": "ble_hid",
  "description": "Operate Vertex-Agent BLE HID: start HID advertising and send media/keyboard/mouse actions.",
  "metadata": {
    "cap_groups": [
      "cap_lua"
    ],
...
```json
{"path":"{CUR_SKILL_DIR}/scripts/start_ble_hid.lua","args":{"name":"vertex-agent-hid"},"timeout_ms":10000}
```
