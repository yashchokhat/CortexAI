...
local image_path = storage.join_path(root, "statistics", "Vertex-Agent.png")
...
local image_path = storage.join_path(storage.get_root_dir(), "statistics", "Vertex-Agent.png")
